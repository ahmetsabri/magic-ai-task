    ...
    Route::prefix('dashboard')->middleware('auth')->name('dashboard.')->group(function () {
        ...
        Route::prefix('admin')->middleware('admin')->name('admin.')->group(function () {
            ...
            Route::prefix('adsense')->name('adsense.')->group(function(){
                Route::get('/',[GoogleAdsenseController::class,'index'])->name('list');
                Route::get('{googleAdsenseCode}',[GoogleAdsenseController::class,'show'])->name('show');
                Route::post('{googleAdsenseCode}',[GoogleAdsenseController::class,'update'])->name('update');
                Route::post('create',[GoogleAdsenseController::class,'store'])->name('create');
                Route::delete('{googleAdsenseCode}',[GoogleAdsenseController::class,'destroy'])->name('delete');
            });
        });
